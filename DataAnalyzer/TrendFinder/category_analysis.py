...
# ====== COMMAND LINE INTERFACE FOR CATEGORY ANALYSIS ======

def get_user_input():
    """Get user input for document paths and context"""
    print("=" * 60)
    print("🔍 CATEGORY ANALYZER - COMMAND LINE INTERFACE")
    print("=" * 60)
...
def run_command_line_analysis():
    ...
    try:
        ...
        if save_choice == 'y':
            ...
            print(f"✅ Results saved to: {categories_filename}")
